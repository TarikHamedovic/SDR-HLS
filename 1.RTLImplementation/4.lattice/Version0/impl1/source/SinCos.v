...
/* Module Version: 1.6 */
/* /home/user/FPGA/tools/diamond/usr/local/diamond/3.13/ispfpga/bin/lin64/scuba -w -n SinCos -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type cosine -addr_width 8 -width 13 -pfu -input_reg -mode 2 -output_reg -area -pipeline 1 -fdc /home/user/SDR-HLS/1.RTLImplementation/4.lattice/Version0/IP/SinCos/SinCos.fdc  */
...
module SinCos (Clock, ClkEn, Reset, Theta, Sine, Cosine)/* synthesis NGD_DRC_MASK=1 */;
    ...
    CCU2C neg_rom_addr0_r_n_3 (.A0(rom_addr0_r_5_inv), .A1(scuba_vlo), .B0(scuba_vlo), 
        .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), 
        .D1(scuba_vhi), .CIN(co2), .S0(rom_addr0_r_n_5), .S1(), .COUT());
    ...
    CCU2C neg_rom_dout_s_n_4 (.A0(rom_dout_7_inv), .A1(rom_dout_8_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
        .D0(scuba_vhi), .D1(scuba_vhi), .CIN(co3), .S0(rom_dout_s_n_7), 
    ...
    CCU2C neg_rom_dout_s_n_6 (.A0(rom_dout_11_inv), .A1(rom_dout_12_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
        .D0(scuba_vhi), .D1(scuba_vhi), .CIN(co5), .S0(rom_dout_s_n_11), 
        .S1(rom_dout_s_n_12), .COUT(co6));

    defparam neg_rom_dout_s_nd.INJECT1_1 = "NO" ;
    defparam neg_rom_dout_s_nd.INJECT1_0 = "NO" ;
    defparam neg_rom_dout_s_nd.INIT1 =  16'h66AA ;
    defparam neg_rom_dout_s_nd.INIT0 =  16'h66AA ;
    CCU2C neg_rom_dout_s_nd (.A0(scuba_vlo), .A1(scuba_vlo), .B0(scuba_vlo), 
        .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), 
        .D1(scuba_vhi), .CIN(co6), .S0(co6d), .S1(), .COUT());
    ...
    CCU2C neg_rom_dout_c_n_0 (.A0(scuba_vlo), .A1(rom_dout_13_inv), .B0(scuba_vlo), 
        .B1(scuba_vhi), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), 
    ...
    CCU2C neg_rom_dout_c_n_1 (.A0(rom_dout_14_inv), .A1(rom_dout_15_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
    ...
    CCU2C neg_rom_dout_c_n_2 (.A0(rom_dout_16_inv), .A1(rom_dout_17_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
    ...
    CCU2C neg_rom_dout_c_n_3 (.A0(rom_dout_18_inv), .A1(rom_dout_19_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
        .D0(scuba_vhi), .D1(scuba_vhi), .CIN(co2_2), .S0(rom_dout_c_n_5), 
        .S1(rom_dout_c_n_6), .COUT(co3_1));
    ...
    CCU2C neg_rom_dout_c_n_4 (.A0(rom_dout_20_inv), .A1(rom_dout_21_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
        .D0(scuba_vhi), .D1(scuba_vhi), .CIN(co3_1), .S0(rom_dout_c_n_7), 
    ...
    CCU2C neg_rom_dout_c_n_5 (.A0(rom_dout_22_inv), .A1(rom_dout_23_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
    ...
    CCU2C neg_rom_dout_c_n_6 (.A0(rom_dout_24_inv), .A1(rom_dout_25_inv), 
        .B0(scuba_vlo), .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), 
        .D0(scuba_vhi), .D1(scuba_vhi), .CIN(co5_1), .S0(rom_dout_c_n_11), 
        .S1(rom_dout_c_n_12), .COUT(co6_1));

    VHI scuba_vhi_inst (.Z(scuba_vhi));

    VLO scuba_vlo_inst (.Z(scuba_vlo));

    defparam neg_rom_dout_c_nd.INJECT1_1 = "NO" ;
    defparam neg_rom_dout_c_nd.INJECT1_0 = "NO" ;
    defparam neg_rom_dout_c_nd.INIT1 =  16'h66AA ;
    defparam neg_rom_dout_c_nd.INIT0 =  16'h66AA ;
    CCU2C neg_rom_dout_c_nd (.A0(scuba_vlo), .A1(scuba_vlo), .B0(scuba_vlo), 
        .B1(scuba_vlo), .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), 
        .D1(scuba_vhi), .CIN(co6_1), .S0(co6_1d), .S1(), .COUT());
