...
def generate_verilog_module(lut_depth, data_width, filename):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", "-fn", type=str, default="sinewave_table.sv", help="Output filename (default: sinewave_table.sv)")
