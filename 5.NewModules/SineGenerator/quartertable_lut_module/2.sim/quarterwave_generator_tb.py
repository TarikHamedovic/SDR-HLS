...
async def simpleSine_test(dut):
    dut._log.info("Test: Starting quarterwave cocotb test")
    # Starting Clock #
    ...
    #dut.phase_increment.setimmediatevalue(16384) # 1.25 MHz for phase_width = 20
    #dut.phase_increment.setimmediatevalue(4) # 1.25 MHz for phase_width = 8
