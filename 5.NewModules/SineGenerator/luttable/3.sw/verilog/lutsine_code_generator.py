...
def write_sine_cosine_table_to_hex(lut_depth, data_width, phase_width, verilog_filename):
    ...
    with open(verilog_filename, "w") as verfp:
        ...
        verfp.write("output reg  signed [DATA_WIDTH-1 :0] sinewave;\n\n")
        ...
        verfp.write("        unique case (phase_accumulator[PHASE_WIDTH-1:PHASE_WIDTH-LUT_WIDTH])\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--filename', type=str, default="sinewave_generator.v", help='Output Verilog filename')
