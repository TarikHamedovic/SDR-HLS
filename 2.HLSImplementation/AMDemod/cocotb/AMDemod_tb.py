...
async def AMDemod_test(dut):
    ...
    for I_in, Q_in in test_data:
        ...
        wait_cycle = 4 # NOTE: Minimal value to wait is 4 (Probably depends on the clock value aswell)
        cocotb.log.info("Test: Calculating output...")
        cocotb.log.info(f"----- Waiting {wait_cycle} clock cycles for the operation to finish -----")
...
-----------------------------------------------------------------------------
 ...
 2024/7/5  TH: Added sqrt_combinatorial module so testing is complete
"""
