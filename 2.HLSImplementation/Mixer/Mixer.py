        ...
        if args.simulate:
            ...
            def testbench():
                ...
                for _ in range(runtime):
                    ...
                    yield dut.sin_in.eq(sin_random_value)
                    yield dut.cos_in.eq(cos_random_value)
                    yield dut.RFIn.eq(RFIn_random_value)
                    ...
                    actual_sin = yield dut.MixerOutSin
                    actual_cos = yield dut.MixerOutCos
