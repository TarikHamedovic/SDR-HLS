...
(* generator = "Amaranth" *)
module Mixer(sinewave_in, cosinewave_in, clk, rst, rf_out, sinewave_out, cosinewave_out, rf_in);
  ...
  always @(posedge clk)
    cosinewave_out <= \$7 ;
  assign \$1  = ~ (* src = "/home/user/SDR-HLS/2.HLSImplementation/Mixer/mixer.py:57" *) rf_in_d_2;
