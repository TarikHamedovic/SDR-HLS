...
(* generator = "Amaranth" *)
module top(data_in, clk, rst, data_out, data_clk, gain);
  ...
  assign \$16  = $signed(comb10) >>> (* src = "/home/user/SDR-HLS/2.HLSImplementation/CIC/CIC.py:126" *) \$15 ;
  (* src = "/home/user/SDR-HLS/2.HLSImplementation/CIC/CIC.py:50" *)
  always @(posedge clk)
    integrator1 <= \$17 ;
  (* src = "/home/user/SDR-HLS/2.HLSImplementation/CIC/CIC.py:51" *)
